...
def prepare_task_data(task_data_path: str,
    ...
    for physio_type, physio_type_info in physio_type_data.items():
        ...
        for experiment in experiments:
            ...
            string_stream.write(message)
            if status:
                experiments_tasks_data[physio_type][experiment]['ping_pong_competitive'] = task_data
            ...
            string_stream.write(f'[{experiment}] Preparing minecraft missions\n')
            ...
            string_stream.write(message)
            if status:
                experiments_tasks_data[physio_type][experiment]['minecraft'] = task_data
