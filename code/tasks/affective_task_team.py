...
class AffectiveTaskTeam:
    ...
    def from_files(cls,
        ...
        if 'lsl_timestamp' in affective_task_team_df.columns:
            affective_task_team_df = affective_task_team_df.drop(columns=['time'])
            affective_task_team_df = affective_task_team_df.rename(
